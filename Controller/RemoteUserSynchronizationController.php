...
class RemoteUserSynchronizationController extends Controller
{
    ...
    public function syncRemoteUserAction()
    {
        ...
        $workspacesTab = isset($datas['workspaces']) ? $datas['workspaces'] : array();
            ...
            if (!is_null($securityToken)) {
                ...
                if (!empty($username) &&
                    ...
                    $userRoles = $this->roleManager
                        ->getNonPlatformRolesForUser($user);
                    $refreshedRoles = array();
                    ...
                    foreach ($workspacesTab as $workspaceLine) {
                        ...
                        $role = $this->roleManager
                            ->getRoleByWorkspaceCodeAndTranslationKey($code, $roleKey);
